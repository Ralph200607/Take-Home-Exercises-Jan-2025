...
namespace TrainSystem
{
    public class Engine
    {
        ...
        public int Weight
        {
            ...
            set
            {
                if (InService) throw new Exception("Cannot modify weight while engine is in service.");
        ...
        public int HorsePower
        {
            ...
            set
            {
                if (InService) throw new Exception("Cannot modify horsepower while engine is in service.");
        ...
        {
            if (string.IsNullOrWhiteSpace(model)) throw new ArgumentNullException(nameof(model), "Model cannot be empty.");
            if (string.IsNullOrWhiteSpace(serialNumber)) throw new ArgumentNullException(nameof(serialNumber), "Serial Number cannot be empty.");
